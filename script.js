...
function initTypingEffect() {
  ...
  function tick() {
    ...
    el.innerHTML = currentRole.slice(0, charIndex) + '<span class="cursor" aria-hidden="true">|</span>';
...
function initContactForm() {
  ...
  try {
    ...
    if (response.ok) {
      status.textContent = `Thanks, ${name}! Your message is on its way — I'll get back to you soon.`;
      form.reset();
    } else {
